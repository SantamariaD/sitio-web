const crearNavbar = () => {
  ...
  nav.innerHTML = `
    <header class="header-area2" style="z-index: 1000">
      ...
      <div class="main-menu">
        ...
        <ul class="menu-list">
          ...
          <li>
            <a href="servicios.html" class="drop-down">Servicios</a>
          </li>
          <li>
            <a href="proyectos.html" class="drop-down">Proyectos</a>
          </li>
          <li>
            <a href="precios.html" class="drop-down">Paquetes</a>
          </li>
          <li class="menu-item-has-children">
            <a href="#" class="drop-down">Empresa</a
            ><i class="bi bi-plus dropdown-icon"></i>
            <ul class="sub-menu">
              <li><a href="conocenos.html">Conócenos</a></li>
              <li><a href="faq.html" class="drop-down">FAQs</a></li>
              <li><a href="blog.html" class="drop-down">Blog</a></li>
            </ul>
          </li>
          <li class="autenticacion-movil">
          ...
          <li class="autenticacion-movil">
            <a style="cursor: pointer;">Cerrar Sesión</a>
          </li>
          <a class="autenticacion-movil" id="nombreUsuarioMovil" style="color: #b573f2"></a>
        </ul>
        <div class="d-lg-none d-block">
          ...
          <div class="header-btn5">
            <a class="primary-btn3" href="contacto.html">Cotiza</a>
          </div>
        </div>
      </div>
      <div class="nav-right d-flex jsutify-content-end align-items-center">
        ...
        <div class="header-btn d-xl-flex d-none">
          <a class="primary-btn3" href="contacto.html">Presupuesto</a>
        </div>
        <a id="registroBoton" style="color: #b573f2" href="registro.html"
          >Registrarse</a
        >
        <a id="loginBoton" style="color: #b573f2" href="login.html">Login</a>

        <div class="dropdown-login">
            <p id="nombreUsuario" class="dropdown-login-item"></p>
...
const rednderizarNav = () => {
  const contenedorNav = document.getElementById("navbar");

  const navbar = crearNavbar();
  contenedorNav.appendChild(navbar);
};
